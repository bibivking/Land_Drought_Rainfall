...
def plot_spatial_wrf_var_Wind(case_names,file_paths,var_name,message,var_unit,height,timeidx,val_min=None,val_max=None):
    ...
    fig.savefig("./plots/WRF_Tinderbox_Drought_Group_Paper/spatial_wrf_"+message+"_"+var_name+"_"+case_names[0]+"_"+str(timeidx) , bbox_inches='tight', pad_inches=0.1)
...
def plot_spatial_wrf_var_Wind_diff(case_names,file_paths,var_name,message,var_unit,height,timeidx,val_min=None,val_max=None):
    ...
    fig.savefig("./plots/WRF_Tinderbox_Drought_Group_Paper/spatial_wrf_diff_"+message+"_"+str(height)+"hPa_"+var_name+"_"+case_names[0]+"_vs_"+case_names[1]+"_"+str(timeidx) , bbox_inches='tight', pad_inches=0.1)
...
def plot_spatial_map_wrf_hgt(file_paths, var_name, height, time_s, time_e, var_unit=None, loc_lat=None, loc_lon=None, message=None):
    ...
    fig.savefig('./plots/WRF_Tinderbox_Drought_Group_Paper/spatial_map_wrf_hgt_'+message , bbox_inches='tight', pad_inches=0.1)
