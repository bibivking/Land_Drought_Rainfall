...
def regrid_vec_to_wrf_domain(n, case_name, lis_input_path, lis_out_path, gridinfo_file):
    ...
    with nc.Dataset(lis_input_file, 'r+') as f_lis_input:
        ...
        original_var       = f_lis_input.variables['SAND']
        for attr_name in original_var.ncattrs():
            sand_vec_out.setncattr(attr_name, original_var.getncattr(attr_name))
        ...
        original_var       = f_lis_input.variables['CLAY']
        for attr_name in original_var.ncattrs():
            sand_vec_out.setncattr(attr_name, original_var.getncattr(attr_name))
        ...
        original_var       = f_lis_input.variables['SILT']
        for attr_name in original_var.ncattrs():
            sand_vec_out.setncattr(attr_name, original_var.getncattr(attr_name))
        ...
        original_var       = f_lis_input.variables['OCSOIL']
        for attr_name in original_var.ncattrs():
            sand_vec_out.setncattr(attr_name, original_var.getncattr(attr_name))
        ...
        original_var       = f_lis_input.variables['BULKDENSITY']
        for attr_name in original_var.ncattrs():
            sand_vec_out.setncattr(attr_name, original_var.getncattr(attr_name))
