...
def extend_LAI_to_2000_by_climology(window_vary=15,window_clim=61):
    ...
    file_in          = "/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_daily/MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2002-2024_SG_filter_window=15timestep_order=2.nc"
    file_clim_common = f"/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_climatology/MCD15A3H.061_clim_5km_commonyear_{window_clim}day_smooth_SG_filter_window=15timestep_order=2.nc"
    file_clim_leap   = f"/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_climatology/MCD15A3H.061_clim_5km_leapyear_{window_clim}day_smooth_SG_filter_window=15timestep_order=2.nc"
    file_out         = f"/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_daily/MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2000-2023_SG_filter_window=15timestep_order=2.nc"
