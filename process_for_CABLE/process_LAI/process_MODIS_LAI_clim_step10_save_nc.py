...
def save_climatology_for_CABLE():
    ...
    file_in      = file_path+"MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2003-2023_climatology_common.nc"
    ...
    file_com            = file_path+"MCD15A3H.061_2003-2023_climatology_5km_common_year.nc"
    ...
    # ======== saving leap year ========
    # create file and write global attributes
    file_leap            = file_path+"MCD15A3H.061_2003-2023_climatology_5km_leap_year.nc"
