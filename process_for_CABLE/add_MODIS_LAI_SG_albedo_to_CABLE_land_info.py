...
def add_time_varying(year,window=31):
    ...
    # ------- read MODIS LAI -------
    file_lai = f"{lai_path}/regrid_2_AWAP_5km_daily/remove_high_frequent_varibility_method2_smooth_anomaly/MCD15A3H.061_500m_aid0001_LAI_regridded_daily_{year}_{window}day_smooth_SG_filter_window=15timestep_order=2.nc"
