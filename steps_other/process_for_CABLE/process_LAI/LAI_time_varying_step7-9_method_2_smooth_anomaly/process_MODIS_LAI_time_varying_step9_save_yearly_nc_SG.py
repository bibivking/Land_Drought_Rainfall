...
def save_daily_varying_for_CABLE(window):
    ...
    '''
    Input:
        MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2000-2023_xxday_smooth_SG_filter_window=15timestep_order=2.nc
    Output:
        MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2000/.../2023_xxday_smooth_SG_filter_window=15timestep_order=2.nc
    ...
    file_in      = '/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_daily/remove_high_frequent_varibility_method2_smooth_anomaly/MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2000-2023_remove_high_freq_SG_filter_window=15timestep_order=2.nc'
    ...
    for yr in np.arange(2000, 2024, 1):
        ...
        file_out            = f"{file_path}MCD15A3H.061_500m_aid0001_LAI_regridded_daily_{str(yr)}_{window}day_smooth_SG_filter_window=15timestep_order=2.nc"
