...
window_vary=31
window_clim=31
python process_MODIS_LAI_time_varying_step7_extend_to_2000.py --window_vary "$window_vary" --window_clim "$window_clim"

# Step 8: remove high frequent varibility
echo "Step 8: remove high frequent varibility"
python process_MODIS_LAI_time_varying_step8_remove_high_frequent_varibility.py

# Step 9: to one file
echo "Step 9: to one file"
cd /g/data/w97/mm3972/scripts/Land_Drought_Rainfall/process_for_CABLE/process_LAI/LAI_time_varying_step7-9_method_2_smooth_anomaly
python process_MODIS_LAI_time_varying_step9_save_yearly_nc.py
