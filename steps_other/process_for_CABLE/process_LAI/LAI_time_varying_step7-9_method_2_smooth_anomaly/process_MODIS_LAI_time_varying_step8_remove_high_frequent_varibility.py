...
def remove_high_frequent_varibility(var_name, file_in, file_out, window, year_s, year_e):
    ...
    file_clim_leap = '/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_climatology/MCD15A3H.061_clim_5km_leapyear_31day_smooth.nc'
    f_leap = Dataset(file_clim_leap, 'r')
    LAI_leap = f_leap.variables['LAI'][:]

    file_clim_common = '/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_climatology/MCD15A3H.061_clim_5km_commonyear_31day_smooth.nc'
    ...
    LAI_anomaly_smooth = LAI_anomaly.rolling(time=window, center=True).mean() #, min_periods=1
...
if __name__ == "__main__":
    ...
    file_in  = "/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_daily/MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2000-2023.nc"
    file_out = '/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_daily/remove_high_frequent_varibility_method2_smooth_anomaly/MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2000-2023_remove_high_freq.nc'
    window   = 31
    year_s   = 2000
    year_e   = 2023
    var_name = 'LAI'
