...
def save_daily_varying_for_CABLE(window):
    ...
    scale_factor = 0.1
    file_path    = "/g/data/w97/mm3972/data/MODIS/MODIS_LAI/AUS/regrid_2_AWAP_5km_daily/"

    # Scaling and reset default values
    file_in      = f"{file_path}MCD15A3H.061_500m_aid0001_LAI_regridded_daily_2000-2023_{window}day_smooth.nc"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--window', type=int, default=0, help='Window size for smoothing at the junction')
    
    args = parser.parse_args()

    save_daily_varying_for_CABLE(args.window)