...
if __name__ == "__main__":
    ...
    # Configure logging
    logging.basicConfig(filename='/g/data/w97/mm3972/scripts/Drought/Land_drought_rainfall/process_for_CABLE/process_albedo/gap_fill.log', level=logging.DEBUG)
